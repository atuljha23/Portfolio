...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to my Website. My name is Atul\nI am a Data Scientist and a Programmer.\n Few Available commands are: help, cd, ls, cat, open.",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "Dublin, Sep. 18—I am a Trinity College Dublin student studying in Computer Science and Statistics.\n I'm looking for opportunities to diversify my skillset. I am interested in developing a wide range of skills in diverse fields that would complement each other in unexpected ways.\nSo I engrained this idea to my lifestyle, and created a goal of learning one new thing in depth every trimester.",
        "projects.txt": "FaceRecognition.\nSentiment Analysis.\n.",
        "contact.txt": "info@atuljha.io",
        "resume.pdf": "https://www.atuljha.io/resume.pdf",
        //"welcome_message.txt":"Hey so looks like you are a developer eh? Well then welcome to my personal website! :)\nI am Atul, and I am a Data Scientist and Programmer.\nCurrently I am an experienced Python developer who mostly worked on Data and machine learning during my internships at NUS Singapore and HPE. I also have knowledge in web development field.\nNow in order to get started, feel free to either execute the 'help' command or use the more user-friendly colored sidenav at your left.\nIn order to skip text rolling, double click/touch anywhere.",
        "social_network_1.txt": "https://www.fb.com/jha.g.no.1/",
